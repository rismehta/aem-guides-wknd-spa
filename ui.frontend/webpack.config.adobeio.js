    ...
    externals: nodeExternals({
        whitelist: [
            ...
            v =>
                ...
                v.indexOf('af-core') !== -1 ||
                v.indexOf('af-react-renderer') !== -1 ||
                v.indexOf('json-formula') !== -1
        ],
    }),
    mode: 'development',
        ...
        rules: [
            {
                ...
                // exclude: /node_modules\/@adobe\/(?!(json-formula)\/).*/,
                options: {
                    babelrc: false,
                    presets: [
                        ['@babel/preset-env'],
                    ...
                    plugins: [
                        ['universal-import'], ['@babel/plugin-proposal-nullish-coalescing-operator'], ['@babel/plugin-proposal-class-properties'], ['@babel/plugin-proposal-optional-chaining']
                    ]
                }
            },
            {
